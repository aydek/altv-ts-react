...
export const ArrowRight: React.FC<Props> = ({ size = 25, ...props }: Props) => {
    return (
        <svg {...props} className={twMerge('fill-whitesmoke', props.className)} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const Account: React.FC<Props> = ({ size = 25, ...props }: Props) => {
    return (
        <svg {...props} className={twMerge('fill-whitesmoke', props.className)} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export const BellIcon: React.FC<Props> = ({ size = 25, ...props }: Props) => {
    return (
        <svg {...props} className={twMerge('fill-whitesmoke', props.className)} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
export const InfoIcon: React.FC<Props> = ({ size = 25, ...props }: Props) => {
    return (
        <svg {...props} className={twMerge('fill-whitesmoke', props.className)} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512">
...
export const WarningIcon: React.FC<Props> = ({ size = 25, ...props }: Props) => {
    return (
        <svg {...props} className={twMerge('fill-whitesmoke', props.className)} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 512">
...
export const ErrorIcon: React.FC<Props> = ({ size = 25, ...props }: Props) => {
    return (
        <svg {...props} className={twMerge('fill-whitesmoke', props.className)} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
...
export const CtrlIcon: React.FC<Props> = ({ size = 25, ...props }: Props) => {
    return (
        <svg className={twMerge('fill-whitesmoke', props.className)} width={size} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 122.88 108.95">
            <g>
